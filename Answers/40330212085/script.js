...
function adjacentHanoi(A, B, C, n) {
    if(n==1){
        moves.push([A, B]);
        moves.push([B, C]);
    }
    else{
        adjacentHanoi(A, B, C, n-1);
        moves.push([A, B]);
        adjacentHanoi(C, B, A, n-1);
        moves.push([B, C]);
        adjacentHanoi(A, B, C, n-1);
    }
}
...
function exhanoi_5(A, B, C, D, n) {
    if (n == 1) {
        adjacentHanoi(C, D, B, 3);
        moves.push([A, D]);
        moves.push([D, C]);
        adjacentHanoi(B, A, C, 5);
    } else {
        moves.push([A, D]);
        adjacentHanoi(B, A, D, 2);
        adjacentHanoi(C, B, A, 6*n+3);
        adjacentHanoi(D, B, C, 3);
        adjacentHanoi(A, B, C, 6*n+3); 
    }
}
