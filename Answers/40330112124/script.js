...
//exhanoi_4 does not allow exchanging disks between A&B and C&D
...
// before coding read about the extra rules for this ExHanoi
//exhanoi_5 does not allow exchanging disks between A&C and B&D
function exhanoi_5(A, B, C, D, n) {
    if(n==1){
        ...
        exhanoi_6(B,A,D,2);
        moves.push([A,B]);
        exhanoi_6(C,B,A,6*n-3);
        moves.push([B,C]);
        moves.push([D,C]);
        moves.push([C,B]);
        moves.push([D,C]);
        moves.push([B,C]);
        exhanoi_6(A,B,C,6*n-3);
    }
}

//exhanoi_6 does not allow exchanging disks between A&C
function exhanoi_6(A,B,C,n){
    if(n==1){
        moves.push([A,B]);
        moves.push([B,C]);
    }else{
