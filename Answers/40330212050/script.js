...
function exhanoi_5(A, B, C, D, n) {
  if (n == 1) {
    ...
    moves.push([A, D]);
    exHanoi_Helper(C, B, A, D, 6 * (n - 1) + 3);
    moves.push([D, C]);
    moves.push([B, C]);
    moves.push([C, D]);
    moves.push([B, C]);
    moves.push([D, C]);
    exHanoi_Helper(A, B, C, D, 6 * (n - 1) + 3);
  }
  return;
}

function exHanoi_Helper(A, B, C, D, n) {
  if (n == 1) {
    moves.push([A, B]);
    moves.push([B, C]);
  } else {
    exHanoi_Helper(A, B, C, D, n - 1);
    moves.push([A, B]);
    exHanoi_Helper(C, D, A, B, n - 1);
    moves.push([B, C]);
    exHanoi_Helper(A, D, C, B, n - 1);
  }
}
