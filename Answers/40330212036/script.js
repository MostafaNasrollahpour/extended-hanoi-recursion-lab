...
function exhanoi_5(A, B, C, D, n) {
    ...
    if (n==1) {
        ...
        moves.push([C, B]); moves.push([C, D]); moves.push([D, A]);
        moves.push([C, D]); moves.push([A, D]); moves.push([B, C]);
        moves.push([C, D]); moves.push([B, A]); moves.push([B, C]);
        moves.push([A, B]); moves.push([B, C]); moves.push([A, B]);
        moves.push([C, B]); moves.push([B, A]); moves.push([C, B]);
        moves.push([A, B]); moves.push([B, C]); moves.push([B, A]);
        moves.push([C, B]); moves.push([B, A]); moves.push([B, C]);
        moves.push([A, B]); moves.push([B, C]); moves.push([A, B]);
        moves.push([C, B]); moves.push([B, A]); moves.push([B, C]);
        moves.push([A, B]); moves.push([B, C]); moves.push([D, A]);
        moves.push([D, C]); moves.push([C, B]); moves.push([D, C]);
        moves.push([B, C]); moves.push([A, B]); moves.push([B, C]);
    } 
    else {

        exhanoi_5(A, B, C, D, n-1);
        moves.push([A, D]);
        exHanoi_P(C, B, A, D, 6*(n-1)+3);
        moves.push([D, C]);
        moves.push([B, C]);
        moves.push([C, D]);
        moves.push([B, C]);
        moves.push([D, C]);
        exHanoi_P(A, B, C, D, 6*(n-1)+3);
    }

    return
}

function exHanoi_P(A, B, C, D, n) {
    if (n==1) {
        moves.push([A, B]);
        moves.push([B, C]);
    } 
        ...
        exHanoi_P(A, B, C, D, n-1);
        moves.push([A, B]);
        exHanoi_P(C, D, A, B, n-1);
        moves.push([B, C]);
        exHanoi_P(A, D, C, B, n-1);
    }
}
