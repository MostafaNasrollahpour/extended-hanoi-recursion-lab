...
function exHanoi_1(start, aux, end, n) {
     if(n==1){
       ...
       moves.push([start,aux]);
       hanoi(end , start , aux , 6*(n-1)); // part of disks
       hanoi(aux , start , end , (6*n - 3)); // for all
    }
}  
...
function exhanoi_5(A, B, C, D, n) {
    if(n==1){
        ...
        moves.push([A,D]);
        tempHanoi(C , D , A , B , 6*n-3);
        moves.push([D,C]);
        moves.push([B,C]);
        moves.push([C,D]);
        moves.push([B,C]);
        moves.push([D,C]);
        tempHanoi(A , B , C , D , 6*n-3);
...
function tempHanoi(A, B, C, D,  n) {
    if(n==1){
        moves.push([A,D]);
        moves.push([D,C]);
    }
    else{
        tempHanoi(A , B , C , D , n-1);
        moves.push([A,B]);
        tempHanoi(C , D , A , B , n-1);
        moves.push([B,C]);
        tempHanoi(A , B , C , D , n-1);
    }
}
