...
function exhanoi_5(A, B, C, D, n) {
  if (n == 1) {
    ...
    moves.push([A, D]);
    helper_for_exHanoi_5(C, B, A, D, 6 * (n - 1) + 3);
    moves.push([D, C]);
    moves.push([B, C]);
    moves.push([C, D]);
    moves.push([B, C]);
    moves.push([D, C]);
    helper_for_exHanoi_5(A, B, C, D, 6 * (n - 1) + 3);
  }
}

function helper_for_exHanoi_5(A, B, C, D, n) {
  if (n == 1) {
    moves.push([A, B]);
    moves.push([B, C]);
  } else {
    helper_for_exHanoi_5(A, B, C, D, n - 1);
    moves.push([A, B]);
    helper_for_exHanoi_5(C, D, A, B, n - 1);
    moves.push([B, C]);
    helper_for_exHanoi_5(A, D, C, B, n - 1);
  }
}
